...
import { SearchThreadItem } from "./SearchThreadItem.mjs";
export const SearchThreadsResponse = core.serialization.object({
    count: Count,
    limit: Limit.optional(),
    nextPageToken: core.serialization.property("next_page_token", PageToken.optional()),
    threads: core.serialization.list(SearchThreadItem),
});
