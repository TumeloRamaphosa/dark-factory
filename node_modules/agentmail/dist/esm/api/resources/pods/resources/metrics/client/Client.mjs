...
export class MetricsClient {
    ...
    __queryEvents(pod_id_1) {
        return __awaiter(this, arguments, void 0, function* (pod_id, request = {}, requestOptions) {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v0/pods/{pod_id}/metrics/events");
        });
    }
    /**
    ...
    __queryUsage(pod_id_1) {
        return __awaiter(this, arguments, void 0, function* (pod_id, request = {}, requestOptions) {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v0/pods/{pod_id}/metrics/usage");
        });
    }
}
